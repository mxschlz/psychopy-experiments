...
try:
	...
	# Create the destination directory if it doesn't exist
	destination_dir_questionnaire = f'G:\\Meine Ablage\\PhD\\data\\SPACEPRIME\\sourcedata\\raw\\sub-{info["subject_id"]}\\questionnaires'
...
# Create the destination directory if it doesn't exist
destination_dir_sequences = f'G:\\Meine Ablage\\PhD\\data\\SPACEPRIME\\sequences\\sub-{info["subject_id"]}'
