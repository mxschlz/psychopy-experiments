...
destination_dir_clean = f'G:\\Meine Ablage\\PhD\\data\\SPACECUE_behavioral_pilot\\derivatives\\preprocessing\\sub-{info["subject_id"]}\\beh'
...
# Create the destination directory if it doesn't exist
destination_dir_raw = f'G:\\Meine Ablage\\PhD\\data\\SPACECUE_behavioral_pilot\\sourcedata\\raw\\sub-{info["subject_id"]}\\beh'
...
try:
	...
	# Create the destination directory if it doesn't exist
	destination_dir_flanker = f'G:\\Meine Ablage\\PhD\\data\\SPACECUE_behavioral_pilot\\sourcedata\\raw\\sub-{info["subject_id"]}\\beh'
...
try:
	...
	# Create the destination directory if it doesn't exist
	destination_dir_questionnaire = f'G:\\Meine Ablage\\PhD\\data\\SPACECUE_behavioral_pilot\\sourcedata\\raw\\sub-{info["subject_id"]}\\questionnaires'
...
# Create the destination directory if it doesn't exist
destination_dir_sequences = f'G:\\Meine Ablage\\PhD\\data\\SPACECUE_behavioral_pilot\\sequences\\sub-{info["subject_id"]}'
...
# get source dir
source_dir_sequences = "sequences"
# get source path
# move all files from that directory to destination
