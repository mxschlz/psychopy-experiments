...
if info["isPilot"]:
    destination_dir_clean = f'S:\\MSchulz\\Meine Ablage\\PhD\\data\\SPACECUE_implicit\\pilot\\sci-{info["subject_id"]}\\beh'
...
glob_file_clean = glob.glob(glob_file)[0].split("\\")[1]
...
# Create the destination directory if it doesn't exist
destination_dir_raw = f'S:\\MSchulz\\Meine Ablage\\PhD\\data\\SPACECUE_implicit\\sourcedata\\raw\\sci-{info["subject_id"]}\\beh'
...
# Create the destination directory if it doesn't exist
destination_dir_sequences = f'S:\\MSchulz\\Meine Ablage\\PhD\\data\\SPACECUE_implicit\\sequences\\sci-{info["subject_id"]}'
